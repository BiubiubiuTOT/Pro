...
import cdsp.android.banner.adapter.CBPageAdapter;
import cdsp.android.banner.holder.CBViewHolderCreator;
import cdsp.android.banner.listener.CBPageChangeListener;
import cdsp.android.banner.listener.OnItemClickListener;
import cdsp.android.banner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private long autoTurningTime; //切换时间
    ...
    private void init(Context context) {
        View view = inflate(context, R.layout.include_viewpager, this);
        viewPager = (CBLoopViewPager) view.findViewById(R.id.cbLoopViewPager);
        pointViewGroup = (ViewGroup) view.findViewById(R.id.loPageTurningPoint);
    ...
    public ConvenientBanner setPointViewVisible(boolean visible) {
        pointViewGroup.setVisibility(visible ? View.VISIBLE : View.GONE);
        return this;
    }
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointViewGroup.addView(pointView);
        }
    ...
    public ConvenientBanner setPageIndicatorAlign(PageIndicatorAlign align) {
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) pointViewGroup.getLayoutParams();
        ...
        pointViewGroup.setLayoutParams(layoutParams);
        return this;
    }
