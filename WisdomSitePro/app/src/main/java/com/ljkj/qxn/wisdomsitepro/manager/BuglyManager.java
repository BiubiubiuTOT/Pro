...
public class BuglyManager {
    ...
    //    private static final String APP_ID = "da0381777c"; //临时的测试
    private static final String APP_ID = "926d26f273"; //正式的
...
//        CrashReport.initCrashReport(context, "da0381777c", isDebug, strategy);
        ...
        Bugly.init(context, APP_ID, false, strategy); //升级SDK已经集成crash上报功能，固无需再集成crash sdk
    }
