...
public class QualityInspectionListV2Activity extends BaseActivity implements
        QualityPatrolContract.View, DistictDataContract.View, AuthorityContract.View {
    ...
    protected void initUI() {
        ...
        recyclerView.setAdapter(adapter = new QualityInspectionListV2Adapter(this));
    ...
    protected void handleAuthority() {
        AuthorityManager.getInstance().handleViewByAuthority(tvRight, AuthorityId.QualityManage.QUALITY_INSPECTION, true);
    }
    ...
    private void initListener() {
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                ...
                patrolPresenter.getQualityPatrolList(UserManager.getInstance().getProjectId(), accidentReason, changeGroup, startDate, endDate, Consts.APPParams.ROWS, 1);
            }
        });
        ...
        refreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(RefreshLayout refreshlayout) {
                ...
                patrolPresenter.getQualityPatrolList(UserManager.getInstance().getProjectId(), accidentReason, changeGroup, startDate, endDate, Consts.APPParams.ROWS, page);
            }
        });
        ...
        adapter.setOnItemClickListener(new QualityInspectionListV2Adapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, int flag) {
                ...
                switch (flag) {
                    case -1://未整改、重新整改
                        QualityInspectionDetailV2Activity.startActivity(QualityInspectionListV2Activity.this, item.getId(), canEdit ? "巡检详情-立即整改" : "巡检详情",
                    ...
                    case 2://整改不通过
                        QualityInspectionDetailV2Activity.startActivity(QualityInspectionListV2Activity.this, item.getId(), canEdit ? "巡检详情-重新整改" : "巡检详情",
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.rb_date: //检查日期
                ...
                break;
            case R.id.tv_right:
                QualityInspectionAddV2Activity.startActivity(QualityInspectionListV2Activity.this);
                break;
            default:
                break;
        }
