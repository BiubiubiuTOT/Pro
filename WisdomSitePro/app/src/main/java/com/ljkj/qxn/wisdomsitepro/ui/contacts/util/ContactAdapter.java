package com.ljkj.qxn.wisdomsitepro.ui.contacts.util;
...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.MyViewHodle> {
    ...
    public void onBindViewHolder(MyViewHodle holder, final int position) {
        ...
        holder.one.setText(name.substring(name.length() - 1, name.length()));
        ...
        //加载联系人头像
//        GlideHelper.loadImage(context,holder.iv,contactInfo.getPhone());
