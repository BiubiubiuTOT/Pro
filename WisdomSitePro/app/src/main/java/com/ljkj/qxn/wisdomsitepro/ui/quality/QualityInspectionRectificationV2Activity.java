 ...
 * 修改备注：
 */
public class QualityInspectionRectificationV2Activity extends QualityInspectionDetailV2Activity
        implements SelectImageCallback, QualityInspectRectifyContract.View, UploadContract.View, ImageCompressorContract.View {
    ...
    protected void initData() {
        ...
        presenter = new QualityInspectRectifyPresenter(this, QualityModel.newInstance());
    ...
    public void showQualityPatrolDetail(QualityPatrolDetailInfo data) {
        super.showQualityPatrolDetail(data);
        ...
        groupLeader2Item.setContent(qualityPatrolDetailInfo.getCheck().getTeamManager());
        postMan2Item.setContent(qualityPatrolDetailInfo.getCheck().getSpokesman());
    }
    ...
    private void rectification(List<FileEntity> entities) {
        ...
        params.put("reformContent", content);
        ...
        presenter.qualityInspectRectify(params);
    }
        ...
        AndPermission.with(this)
                ...
                .onGranted(new Action<List<String>>() {
                    ...
                    public void onAction(List<String> permissions) {
                        //图片选择
                        PhotoPickerHelper.startPicker(QualityInspectionRectificationV2Activity.this, 0, filePaths);
                    }
                })
    ...
    private void uploadFile(List<String> paths) {
        ...
        uploadPresenter.upload("123", files);
    }
