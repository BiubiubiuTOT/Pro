...
import com.ljkj.qxn.wisdomsitepro.presenter.quality.QualityPatrolAddPresenterV2;
...
public class QualityInspectionAddV2Activity extends BaseActivity implements
        SelectImageCallback, QualityPatrolAddContractV2.View,
    ...
    private QualityPatrolAddPresenterV2 patrolAddPresenter;
    ...
    protected void initData() {
        ...
        patrolAddPresenter = new QualityPatrolAddPresenterV2(this, QualityModel.newInstance());
        ...
        addPresenter(patrolAddPresenter);
    ...
    public void addImage() {
        AndPermission.with(QualityInspectionAddV2Activity.this)
                .runtime()
                ...
                .onGranted(new Action<List<String>>() {
                    ...
                    public void onAction(List<String> permissions) {
                        //图片选择
                        PhotoPickerHelper.startPicker(QualityInspectionAddV2Activity.this, 0, filePaths);
    ...
    public static void startActivity(Context context) {
        context.startActivity(new Intent(context, QualityInspectionAddV2Activity.class));
    }
    ...
    private void initFloorWindow() {
        ...
        floorOptions = new OptionsPickerBuilder(this, new OnOptionsSelectListener() {
            @Override
            public void onOptionsSelect(int options1, int option2, int options3, View v) {
                String str = floorItems1.get(options1) + floorItems2.get(options1).get(option2);
                itemBuildFloor.setContent(str);

                floor = String.valueOf(option2 + 1);
                building = String.valueOf(options1 + 1);
    ...
    @Override
    public void showQualityPatrolAddResult(String data) {
    ...
    private void post(List<FileEntity> entities) {
        ...
        params.put("whyType", reason);//事故原因
        ...
        params.put("checkInfo", question);//隐患整改内容
        params.put("projId", UserManager.getInstance().getProjectId());
        params.put("lossType", lossIndex);//人员伤亡或经济损失分类
        params.put("spokesman", createUser);//发文人
        params.put("createUserId", UserManager.getInstance().getUserId());
        params.put("createUserName", createUser);
        params.put("checkPosition", position);//检查位置
        params.put("building", building);//楼栋
        params.put("floor", floor);//楼层
        params.put("reformDate", itemDateEnd.getContent());//楼层
        patrolAddPresenter.qualityPatrolAdd(params);
    }
}
