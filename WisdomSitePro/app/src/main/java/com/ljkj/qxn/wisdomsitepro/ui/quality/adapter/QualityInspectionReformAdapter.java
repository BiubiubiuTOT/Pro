 ...
 * 修改备注：
 */
public class QualityInspectionReformAdapter extends BaseRecyclerAdapter<QualityPatrolDetailInfo.ReformBean, QualityInspectionReformAdapter.ViewHolder> {
    private String teamLeader;

    public QualityInspectionReformAdapter(Context mContext) {
        super(mContext);
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        QualityPatrolDetailInfo.ReformBean reform = getItem(position);
        ...
        holder.rectifyContentText.setText(reform.getReformContent());
        int status = reform.getCheckStatus();
        if (status == 2) {
            ...
            holder.reasonText.setText("不合格原因：" + reform.getCheckStatusContent());
        } else if (status == 0) {
