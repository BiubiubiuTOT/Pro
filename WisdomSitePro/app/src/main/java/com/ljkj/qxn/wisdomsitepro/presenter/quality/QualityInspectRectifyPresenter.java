...
public class QualityInspectRectifyPresenter extends QualityInspectRectifyContract.Presenter {
    public QualityInspectRectifyPresenter(QualityInspectRectifyContract.View view, QualityModel model) {
        super(view, model);
    }

    @Override
    public void qualityInspectRectify(HashMap params) {
        model.qualityInspectRectify(params, new JsonCallback<ResponseData<String>>(new TypeToken<ResponseData<String>>() {
        }) {
            @Override
            public void onStart() {
                super.onStart();
